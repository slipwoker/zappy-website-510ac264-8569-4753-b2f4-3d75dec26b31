document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function getErrorMessage(field) {
      ...
      if (validity.typeMismatch) {
        return errorMessages.typeMismatch[field.type] || errorMessages.typeMismatch.default;
      }
      if (validity.tooShort) return errorMessages.tooShort(field.minLength);
      if (validity.tooLong) return errorMessages.tooLong(field.maxLength);
      if (validity.patternMismatch) return field.dataset.patternError || errorMessages.patternMismatch;
    ...
    function showError(field, message) {
      ...
      field.setAttribute('aria-describedby', errorEl.id || (errorEl.id = 'err-' + (field.id || field.name || Math.random().toString(36).slice(2))));
    }
  ...
  const ANIMATE_SELECTOR = '.fade-in, .scroll-animate, [data-animate]';
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "פינה מירושלים משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '510ac264-8569-4753-b2f4-3d75dec26b31',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '510ac264-8569-4753-b2f4-3d75dec26b31';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '510ac264-8569-4753-b2f4-3d75dec26b31';
